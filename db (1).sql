...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-05-2024 a las 23:26:15
...
--
ALTER TABLE `detalle_pres`
  MODIFY `id_de_pres` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=162;

--
-- AUTO_INCREMENT de la tabla `detalle_usuarios`
--
ALTER TABLE `detalle_usuarios`
  MODIFY `id_detalle` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `herrramienta`
  MODIFY `id_herramienta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
