    ...
    if ($nit == "") {
        ...
        if ($empresa) {
            ...
            if ($licenciaCount > 0) {
                ...
                $insertsql = $conectar->prepare("INSERT INTO licencia ( licencia, estado, fecha_inicio, fecha_fin, nit) VALUES (?, ?, 'activo', ?, ?, ?)");
                $insertsql->execute([ $licencia, $fecha_inicio, $fecha_fin, $nit]);
