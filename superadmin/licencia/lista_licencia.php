        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                <?php foreach ($asigna as $usua) { ?>
                    ...
                    if ($fecha_actual > $usua["fecha_fin"]) {
                        $id_licencia = $usua["licencia"];

                        $query_update_estado = "UPDATE licencia SET estado = 'inactivo' WHERE licencia = :id_licencia";
                        $statement = $conectar->prepare($query_update_estado);
                        $statement->bindParam(':id_licencia', $id_licencia, PDO::PARAM_INT);
                        $statement->execute(); // Ejecutar la consulta para actualizar el estado de la licencia
                    }
                    ?>
                    <tr>
                        <td><?= $usua["licencia"] ?></td>
