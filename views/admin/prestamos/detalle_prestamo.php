...
if (isset($_SESSION['documento'])) {
    ...
    if (isset($_GET['id'])) {
        ...
        // Consulta para obtener los detalles del préstamo y las herramientas asociadas al préstamo específico
        ...
        $usua->execute();
        $asigna = $usua->fetchAll(PDO::FETCH_ASSOC); // Se obtienen los detalles del préstamo y las herramientas asociadas
    } else {
...
<body class="main-layout in_page">
    ...
    <div class="container mt-3">
        ...
        <a href="lista_prestamos.php" class="btn btn-danger" style="margin-bottom: 10px;">Regresar</a>
    </div>
