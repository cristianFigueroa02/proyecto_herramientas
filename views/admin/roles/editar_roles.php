...
if (isset($_GET['id'])) {
    ...
    $validar = $conectar->prepare("SELECT * FROM rol WHERE id_rol = ?");
    $validar->execute([$id]);
    $rol = $validar->fetch();
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $updateQuery = $conectar->prepare("UPDATE rol SET rol = ? WHERE id_rol = ?");
        $updateQuery->execute([$nombre, $id]);
...
<body class="main-layout in_page">
    ...
    <section class="section">
        <div class="container my-5">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    <form method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo $rol['id_rol']; ?>" disabled>
                        </div>
                        <div class="form-group">
                            <label for="nombre">Nombre del rol:</label>
                            <input type="text" class="form-control" value="<?php echo $rol['rol']; ?>" id="nombre" name="nombre" required>
                        </div>
                </div>
            ...
            <a href="lista_roles.php" class="btn btn-danger">Volver</a>
        </div>
        </div>
    </section>
    <footer>
