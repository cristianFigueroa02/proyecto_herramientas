...
if (isset($_SESSION['documento'])) {
    ...
    $usua = $conectar->prepare("SELECT * FROM rol WHERE id_rol NOT IN (1, 3)");
    $usua->execute();
                ...
                <?php foreach ($asigna as $usua) { ?>
                    <tr style="text-align:center;">
                        ...
                        <td>
                            ...
                            <a href="eliminar_rol.php?id=<?= $usua["id_rol"] ?>" class="btn btn-danger" onclick="return confirm('¿Está seguro de que desea eliminar este rol?')">Eliminar</a>
