...
if (isset($_GET['id'])) {
    ...
    $validar = $conectar->prepare("SELECT * FROM categoria WHERE id_cate = ?");
    $validar->execute([$id]);
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($resultado) {
            ...
            header("Location: lista_tipos.php?error=1&mensaje=Error al actualizar"); // Redirigir con error si la consulta falló
            exit();
        }
    }
}
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    <form method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo $herramientas['categoria']; ?>" id="nombre" name="nombre" required>
                        </div>
                </div>
