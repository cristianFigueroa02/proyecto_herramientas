...
if (isset($_SESSION['documento'])) {
    ...
    $usua = $conectar->prepare("SELECT * FROM categoria ");
    $usua->execute();
...
<body class="main-layout in_page">
    ...
    <div class="container mt-3">
        <a href="crear_tipo.php" class="btn btn-success mb-2">Crear un tipo</a>
            ...
            <tbody>
                ...
                <?php foreach ($asigna as $usua) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="editar_tipo.php?id=<?= $usua["id_cate"] ?>" class="btn btn-primary ">Actualizar</a>
                            <a href="eliminar_tipo.php?id=<?= $usua["id_cate"] ?>" class="btn btn-danger" onclick="return confirm('¿Está seguro de que desea eliminar este tipo?')">Eliminar</a>
