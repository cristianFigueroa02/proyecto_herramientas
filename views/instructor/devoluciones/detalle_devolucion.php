...
if (isset($_SESSION['documento'])) {
    // Si 'documento' está definido en la sesión, lo asignamos a una variable
    $documento = $_SESSION['documento'];

    if (isset($_GET['id'])) {
        // Si 'id' está definido en la URL, lo asignamos a una variable
        $id = $_GET['id'];

        // Consulta para obtener información del usuario basada en el documento de la sesión
        ...
        // Consulta para obtener los préstamos del usuario actual con estado 'prestado'
        // Consulta para obtener los préstamos del usuario actual con estado 'prestado'
        $usua = $conectar->prepare("SELECT prestamos.estado_prestamo, detalle_pres.*, herrramienta.* 
                            FROM detalle_pres 
                            ...
                            INNER JOIN categoria ON herrramienta.id_cate=categoria.id_cate
...
<body class="main-layout in_page">
                    ...
                    <div class="col-md-12 col-sm-3 col logo_section">
                        <div class="full">
                            <div class="center-desk">
                                <div class="logo">
                                    <a href="../index.php"><img src="../../../images/Sena_Colombia_logo.svg.png" alt="#" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container mt-3">
        ...
        <a href="lista_devoluciones.php" class="btn btn-danger" style="margin-bottom: 10px;">Regresar</a>
    </div>
