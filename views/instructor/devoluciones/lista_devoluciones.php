...
if (isset($_SESSION['documento'])) {
    ...
    $usua = $conectar->prepare("SELECT * FROM prestamos INNER JOIN usuario ON prestamos.documento = usuario.documento ");
    $usua->execute();
...
<body class="main-layout in_page">
    ...
    <div class="container mt-3">
        ...
        <div class="table-responsive">
            ...
            <input type="text" id="searchInput" class="form-control mb-2 search-input" placeholder="Buscar devoluciones">
