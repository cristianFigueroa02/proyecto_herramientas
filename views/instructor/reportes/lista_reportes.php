...
if (isset($_SESSION['documento'])) {
    ...
    INNER JOIN usuario ON prestamos.documento = usuario.documento WHERE reportes.estado_reporte='activo'");
    $usua->execute();
                        ...
                        <nav class="navigation navbar navbar-expand-md navbar-dark ">
                            ...
                            <div class="collapse navbar-collapse" id="navbarsExample04">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="lista_reportes_inactivo.php">Lista de reportes inactivos</a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
                    ...
                    <?php foreach ($asigna as $usua) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="inactivar.php?id=<?= $usua["id_reporte"] ?>" class="btn btn-danger" onclick="return confirm('¿Estás seguro de inactivar el reporte?')">inactivar</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
