...
if (isset($_SESSION['documento'])) {
    ...
    INNER JOIN usuario ON prestamos.documento = usuario.documento WHERE reportes.estado_reporte='inactivo'");
    $usua->execute();
                        ...
                        <nav class="navigation navbar navbar-expand-md navbar-dark ">
                            ...
                            <div class="collapse navbar-collapse" id="navbarsExample04">
                                <ul class="navbar-nav mr-auto">
                                    <li class="nav-item">
                                        <a class="nav-link" href="lista_reportes.php">Lista de reportes activos</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#">Lista de reportes inactivos</a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
