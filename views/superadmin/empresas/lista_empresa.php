<?php
    ...
    <body class="main-layout in_page">
        ...
        <div class="container mt-3">
            <a href="crear_empresa.php" class="btn btn-success mb-2">Crear un arma</a>
                ...
                <tbody>
                    ...
                    <?php foreach ($asigna as $usua) { ?>
                        <tr>
                            ...
                            <td><?= $usua["telefono"] ?></td>
                            <td>
                                <a href="actualizar_arma.php?id=<?= $usua["nit"] ?>" class="btn btn-primary " >Actualizar</a>
                                <a href="eliminar_arma.php?id=<?= $usua["nit"] ?>" class="btn btn-danger">Eliminar</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
