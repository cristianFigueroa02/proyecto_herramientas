...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["herramientas"])) {
    ...
    // Recorre cada herramienta prestada
    ...
    // Actualizar el estado del préstamo a 'devuelto' si todas las herramientas han sido devueltas en su totalidad
    ...
    if (count($herramientas_restantes) > 0) {
