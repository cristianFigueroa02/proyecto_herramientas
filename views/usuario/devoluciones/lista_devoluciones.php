...
if (isset($_SESSION['documento'])) {
    ...
    $usua = $conectar->prepare("SELECT * FROM prestamos INNER JOIN usuario ON prestamos.documento = usuario.documento WHERE prestamos.estado_prestamo = 'devuelto' AND usuario.documento='$documento'");
    $usua->execute();
...
<body class="main-layout in_page">
                        ...
                        <nav class="navigation navbar navbar-expand-md navbar-dark ">
                            ...
                            <div class="collapse navbar-collapse" id="navbarsExample04">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link" href="lista.php">tus prestamos</a>
                                    </li>
                                    <li class="nav-item active">
                                        <a class="nav-link" href="#">tus devoluciones</a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
    ...
    <div class="container mt-3">
        <h2 style="text-transform:uppercase;">tus devoluciones</h2>
