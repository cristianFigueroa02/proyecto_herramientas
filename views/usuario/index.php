        ...
        <div class="servicios">
            <a href="prestamos/prestamos.php" class="enlace-servicio">
                <section class="servicio">
                    ...
                    <p> Apartado para hacer prestamos y tambien para hacerle seguimiento </p>
                </section>
            </a>
            <a href="devoluciones/lista.php" class="enlace-servicio">
                <section class="servicio">
                    ...
                    <p>Apartado para hacer devoluciones y hacerle seguimiento </p>
                </section>
            </a>
            <a href="reportes/lista_reportes.php" class="enlace-servicio">
                <section class="servicio">
                    <h3 style="text-transform: uppercase;">tus reportes</h3>
                    <div class="iconos">
